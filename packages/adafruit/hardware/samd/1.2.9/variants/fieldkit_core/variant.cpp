...
const PinDescription g_APinDescription[]=
{
  ...
  { PORTC, 22, PIO_SERCOM,  PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },   // Wire2 (Radio) SDA
  { PORTC, 23, PIO_SERCOM,  PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },   // Wire2 (Radio) SCL
  ...
  { PORTB, 20, PIO_SERCOM,  PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },   // Wire1 (Core)
  { PORTB, 21, PIO_SERCOM,  PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },   // Wire1 (Core)
  ...
  { PORTC, 17, PIO_SERCOM,  PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER,  EXTERNAL_INT_NONE },  // MODULE I2C (SD?)
  { PORTC, 16, PIO_SERCOM,  PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER,  EXTERNAL_INT_NONE },  // MODULE I2C (SCL)
  ...
  // ----------------------
  { PORTB, 20, PIO_SERCOM, PIN_ATTR_DIGITAL, No_ADC_Channel, TCC1_CH2, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // SDA (?)
  { PORTB, 21, PIO_SERCOM, PIN_ATTR_DIGITAL, No_ADC_Channel, TCC1_CH3, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // SCL (?)
